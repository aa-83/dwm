...
static const char *fonts[]          = { "monospace:size=11", "JoyPixels:pixelsize=11:antialias=true:autohint=true", "adobe-source-han-serif-otc-fonts=14:antialias=true:autohint=true" };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_c,      setlayout,      {.v = &layouts[5]} }, { MODKEY|ControlMask,           XK_space,  setlayout,      {0} }, { MODKEY|ShiftMask,             XK_space,  togglefloating, {0} }, { MODKEY,                       XK_0,      view,           {.ui = ~0 } },
